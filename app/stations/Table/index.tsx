      ...
      <tbody>
        {listItems.map((item: { name: string; location: string }, idx: number) => (
          <tr key={item.name} className="hover:bg-grey-lighter ">
            <td className="py-4 px-4 border-b border-grey-light ">{idx + 1}</td>
            <td className="py-4 px-4 border-b border-grey-light">{item.name}</td>
            <td className="py-4 px-4 border-b border-grey-light ">{item.location}</td>
          </tr>
        ))}
      </tbody>
    </table>
